...
- **Multiple centerpiece diagrams allowed.** A system apex typically pairs topology + canonical flow under `## How it works`. Standalone apexes use diagrams at discretion (many legitimately have none — a deployment matrix doesn't need a flowchart).
