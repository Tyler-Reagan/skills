...
General-purpose developer tooling skills not tied to a specific infrastructure or firmware domain.
...
| [`doc-taxonomy-cleanup`](doc-taxonomy-cleanup/SKILL.md) | Diagnostic | Cleaning up a poisoned documentation tree — triage every doc into plans/decisions/archive/delete, rewrite promoted docs as code-grounded decision records, distill into a single load-bearing troubleshooting.md |
