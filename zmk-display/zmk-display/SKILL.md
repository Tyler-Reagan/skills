...
**Scope: ZMK v0.3 only.** ZMK `main` uses Zephyr 4.1 and LVGL v9, with a new board qualifier format and updated CI workflow. All community display modules (nice-view-gem, nice-shield-collection) currently target v0.3 / LVGL v8. Do not apply this skill to ZMK `main` builds.
